...
return [
    ...
    'dependencies' => [
        'factories' => [
            Command\DiffCommand::class => PsrContainerDoctrine\MigrationsCommandFactory::class,
            Command\DumpSchemaCommand::class => PsrContainerDoctrine\MigrationsCommandFactory::class,
            Command\ExecuteCommand::class => PsrContainerDoctrine\MigrationsCommandFactory::class,
            Command\GenerateCommand::class => PsrContainerDoctrine\MigrationsCommandFactory::class,
            Command\LatestCommand::class => PsrContainerDoctrine\MigrationsCommandFactory::class,
            Command\MigrateCommand::class => PsrContainerDoctrine\MigrationsCommandFactory::class,
            Command\RollupCommand::class => PsrContainerDoctrine\MigrationsCommandFactory::class,
            Command\StatusCommand::class => PsrContainerDoctrine\MigrationsCommandFactory::class,
            Command\UpToDateCommand::class => PsrContainerDoctrine\MigrationsCommandFactory::class,
            Command\VersionCommand::class => PsrContainerDoctrine\MigrationsCommandFactory::class,
        ],
    ],
];
